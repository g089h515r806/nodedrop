...
class VocabularyDelete extends Component {
  state = {
	id:'',
    email: '',
    name: '',
  ...
  setTitle() {
	const { t } = this.props;
	document.title = t('Delete vocabulary');	  
  }
        ...
        <div className={classes.root}>
          <Grid container justify="center"> 
            <Grid spacing={24} alignItems="center" justify="center" container className={classes.grid}>
              <Grid item xs={12}>
			  <p>{t('Are you sure that you want to delete vocabulary')}:{this.state.name} ?</p>
...
export default withRouter(withTranslation()(withStyles(styles)(VocabularyDelete)))
