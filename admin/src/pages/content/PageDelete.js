...
class PageDelete extends Component {
  ...
  constructor(props) {
	...
	//this.props.title = t('Delete page');
        ...
        <div className={classes.root}>
          <Grid container justify="center"> 
            <Grid spacing={3} alignItems="center" justify="center" container className={classes.grid}>
              <Grid item xs={12}>
			  <p>{t('Are you sure that you want to delete page')}: {(this.state.content && this.state.content.title) || ""} ?</p>
...
export default withRouter(withTranslation()(withStyles(styles)(PageDelete)))
