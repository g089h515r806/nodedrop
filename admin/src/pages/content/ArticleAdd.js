              ...
              <Grid item xs={12}>
				...
				<form className={classes.form} onSubmit={this.handleSubmit}>
					...
					<Grid item xs={12} sm={12}>
						...
						<Select native  id="category" name="category" displayEmpty input={<Input />}  value={this.state.content.category || ""} onChange={this.handleInputChange}>
						  <option value="" />
					...
					<Grid item xs={12} sm={12}> 
					 ...
					 <MyEditor value={this.state.content.body || ""} onChange={this.handleEditorChange.bind(this)} ref="body" />
					  </div>
					</Grid>  
					<Grid item xs={12} sm={12}>  
...
export default withRouter(withTranslation()(withStyles(styles)(ArticleAdd)))
