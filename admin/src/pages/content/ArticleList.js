     ...
     <DefaultLayout title={this.props.title}>
        ...
        <div className={classes.root}>
          ...
          <Button
			...
			component={Link} to="/content/article/add"
          >
           {t('Add article')}
          </Button>
						...
						<TableBody>
						  {this.state.rows.map(row => (
							<TableRow key={row._id}>
							  ...
							  <TableCell align="center"><Link to={`/content/article/${row._id}/edit`}><EditIcon/></Link></TableCell>
							  <TableCell align="center"><Link to={`/content/article/${row._id}/delete`}><DeleteForeverIcon/></Link></TableCell>
							</TableRow>
						  ))}
						</TableBody>
                        <TableFooter>
...
export default withTranslation()(withStyles(styles)(ArticleList));